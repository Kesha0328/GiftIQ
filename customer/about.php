...
/* Helper class for responsive rows */
.team-row {
  display: flex;
  gap: 16px;
  justify-content: center;
...
.team-member-icon {
  ...
  background: #fff8f6; /* Light pink background for the circle */
  
  /* Centering icon inside the circle */
  display: flex;
  align-items: center;
  justify-content: center;
...
@media (max-width: 768px) {
  ...
  /* Rule for the first "main" team member */
  ...
  .team-row .team-member .team-member-icon {
    width: 95px;
    height: 95px;
    margin-bottom: 12px;
    font-size: 2.5rem; /* Smaller icon for smaller circle */
  }
  
  .team-row .team-member h3 {
    font-size: 16px;
    margin-bottom: 6px;
  }
  .team-row .team-member .role {
    font-size: 13px;
    margin-bottom: 10px;
  }
}
...
@media (max-width: 420px) {
  /* Stack the 2-column rows into 1 column */
  .team-row {
    flex-wrap: wrap;
  }
  .team-row .team-member {
