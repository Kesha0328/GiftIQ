...
<section class="hero">
  ...
  <section class="featured">
    ...
    <div class="cards">
      <div class="card">
        <img src="customer/images/10.jpeg" alt="Hamper 1"/>
        <h3>Classic Love Box</h3>
        <p>₹1,499</p>
        <a href="../customer/collection.php" class="btn-primary">Add to Cart</a>
      </div>
      <div class="card">
        <img src="customer/images/5.jpeg" alt="Hamper 2"/>
        <h3>Birthday Bliss</h3>
        <p>₹1,799</p>
        <a href="../customer/collection.php" class="btn-primary">Add to Cart</a>
      </div>
      <div class="card">
        <img src="customer/images/6.jpeg" alt="Hamper 3"/>
        <h3>Elegant Joy Crate</h3>
        <p>₹2,099</p>
        <a href="../customer/collection.php" class="btn-primary">Add to Cart</a>
      </div>
      <div class="card">
        <img src="customer/images/7.jpeg" alt="Hamper 4"/>
        <h3>Festive Cheer Basket</h3>
        <p>₹1,999</p>
        <a href="../customer/collection.php" class="btn-primary">Add to Cart</a>
      </div>
      <div class="card">
        <img src="customer/images/8.jpeg" alt="Hamper 5"/>
        <h3>Wellness Delight</h3>
        <p>₹1,599</p>
        <a href="../customer/collection.php" class="btn-primary">Add to Cart</a>
      </div>
      <div class="card">
        <img src="customer/images/9.jpeg" alt="Hamper 6"/>
